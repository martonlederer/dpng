...
//searching in crc32
function lookUpcrc32 (buffer: Uint8Array, offset: number, size: number) {
...
//writing
function write4 (buffer: Uint8Array, offset: number, value: number) {
...
function write2 (buffer: Uint8Array, offset: number, value: number) {
...
function write2lsb (buffer: Uint8Array, offset: number, value: number) {
...
export default class PNGImage {
  ...
  getBase64 (): string {
    ...
    this.deflate()
    return base64.fromUint8Array(new Uint8Array(this.buffer.buffer))
